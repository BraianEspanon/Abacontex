...
function obtenerNombreRol(rolEmpresa: unknown): string {
  if (
    !rolEmpresa ||
    typeof rolEmpresa !== 'object'
  ) {
    return 'Sin rol asignado';
  }

  if (
    'nombreRol' in rolEmpresa &&
    typeof rolEmpresa.nombreRol === 'string'
  ) {
    return rolEmpresa.nombreRol;
  }

  if (
    'nombre' in rolEmpresa &&
    typeof rolEmpresa.nombre === 'string'
  ) {
...
export default function ResumenIntegrantes({
  integrantes,
}: ResumenIntegrantesProps) {
