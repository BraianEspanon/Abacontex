        ...
        scrolled
          ...
          : 'bg-transparent px-6 py-4 rounded-none border-b border-transparent'
            ...
            <ul className="hidden lg:flex items-center gap-8 font-sans font-medium text-abacontex-gray-text text-sm">
                <li><a href="#" className="hover:text-abacontex-primary transition-colors duration-300">Inicio</a></li>
                <li><a href="#caracteristicas" className="hover:text-abacontex-primary transition-colors duration-300">Características</a></li>
                <li><a href="#simulacion" className="hover:text-abacontex-primary transition-colors duration-300">Simulación Alumnos</a></li>
                <li><a href="#docentes" className="hover:text-abacontex-primary transition-colors duration-300">Panel Docente</a></li>
            </ul>
                ...
                {initialized && keycloak.authenticated && (
                    <div className="flex items-center gap-5">
                        <span className="font-sans font-medium text-abacontex-black-text hidden md:inline">
                            Hola, <span className="text-abacontex-primary">{keycloak.tokenParsed?.preferred_username || 'Usuario'}</span>
                        </span>
                        <Button 
                            label="Cerrar Sesión" 
                            variant="outline" 
